...
class Bill extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('companyName, dateCreate, billNumber', 'required'),
            array('companyName', 'length', 'max' => 100),
            array('billNumber', 'length', 'max' => 4),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('billId, companyName, dateCreate, billNumber', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function attributeLabels() {
        return array(
            'billId' => 'Bill',
            'companyName' => 'บริษัท/ห้าง/ร้าน',
            'dateCreate' => 'วันที่',
            'billNumber' => 'เลขที่ใบวางบิล',
        );
    }
